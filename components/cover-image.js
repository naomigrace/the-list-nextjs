      ...
      <Link as={as} href={href} className="inline-block">
        <a aria-label={title}>
          <div
            ...
            className={`z-0 h-full max-h-52 transition duration-500 bg-black hover:${color} flex-1 sm:mx-0 w-full lg:max-w-xs relative rounded-xl cursor-pointer hover:shadow-lg`}
          >
